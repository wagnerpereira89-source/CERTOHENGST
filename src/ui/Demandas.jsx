...
export default function Demandas({ t, demandas, projetos, responsaveis = [], novaDemanda, abrirDemanda, moverDemanda }) {
  ...
  const porEtapa = (id) =>
    demandas
      .filter((d) => d.status === id && passaFiltro(d))
  ...
  const barraFiltros = (
    ...
    >
      ...
      <select
        ...
        style={estiloFiltro(t, fPrioridade !== 'todas')}
      >
      ...
      <select
        ...
        style={estiloFiltro(t, fResponsavel !== 'todos')}
      >
        ...
        {lista.length === 0 ? (
          <Vazio t={t}>
            {filtrando
              ...
              : `Nenhuma demanda em "${ETAPAS.find((e) => e.id === abaEtapa)?.rotulo}".`}
          </Vazio>
        ) : (
